...
function App() {
  return (
    <div className=" ">
      <div className="flex py-4 md:px-6 xl:justify-between justify-between md:justify-around pr-5 bottom-1 border-gray-100  border-2 text-gray-500">
      ...
      <div className=" pl-12 pr-4 pb-4 space-x-5 text-sm mt-4  border-b-2 text-gray-500 border-gray-100 hidden md:block">
